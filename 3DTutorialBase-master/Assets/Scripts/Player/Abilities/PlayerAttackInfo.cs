...
public class PlayerAttackInfo
{
    ...
    [SerializeField]
    [Tooltip("The button to press to activate the attack. ")]
    ...
    [SerializeField]
    [Tooltip("The trigger string to activate the attack in the animator. ")]
    ...
    [SerializeField]
    [Tooltip("How long to wait before the attack is launched after the button is pressed. ")]
    ...
    [SerializeField]
    [Tooltip("How long to wait before the player can do anything again after lauching an attack. ")]
